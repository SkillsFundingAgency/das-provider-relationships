...
namespace SFA.DAS.ProviderRelationships.DependencyResolution
{
    public class ApprenticeshipInfoServiceApiRegistry : Registry
    {
        public ApprenticeshipInfoServiceApiRegistry()
        {
            ...
            For<ApprenticeshipInfoServiceApiConfiguration>().Use(c => c.GetInstance<ITableStorageConfigurationService>().Get<ApprenticeshipInfoServiceApiConfiguration>(ConfigurationKeys.ApprenticeshipInfoServiceApi)).Singleton();
