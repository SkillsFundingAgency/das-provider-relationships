...
{
    public class AccountProviderLegalEntityUpdatedPermissionsEvent
    {
        ...
        public AccountProviderLegalEntityUpdatedPermissionsEvent(long ukprn, int accountProviderId, string accountProviderName, 
